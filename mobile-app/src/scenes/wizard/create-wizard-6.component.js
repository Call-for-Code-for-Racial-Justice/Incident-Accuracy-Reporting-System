...
import ContentView from "../../layouts/wizard/screen6.component";

import wizardIncidentContext from "../../services/wizard-incident-content.service";

export const CreateWizardScreen6 = ({ route, navigation }) => {
  ...
  const renderBackAction = () => (
    <Button
      ...
      disabled={false}
      appearance="outline"
      accessoryRight={ArrowIosBackIcon}
      size='small'
  ...
  const renderNextAction = () => (
    <Button
      style={styles.navButton}
      disabled={incident.description==null}
      appearance="outline"
