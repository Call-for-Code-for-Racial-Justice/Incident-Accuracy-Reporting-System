When con# Contributing

tributing a major change to this repository, please first discuss the change you wish to make via an [issue](contributing/ISSUES.md). Minor issues can simply be addressed by sending by a pull request.
